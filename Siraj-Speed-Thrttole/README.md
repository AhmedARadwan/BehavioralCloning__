...
# Dense models
- Steering with speed (train_speed)
- Steering with throttle (train_throttle)

# output of training
model saves best results only. This means if you trained for 500 epochs but the least loss was at epoch 300. All epochs after 300 will not be saved.
You can change this by making save_best_only = False (Not Recommended)

# Drive files
- run drive_speed with speed.h5
- run drive_thrttle with throttle.h5 

# Data
file 'TrainingV3' should be in same directory
