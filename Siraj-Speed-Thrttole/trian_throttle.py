...
def load_data(args):
    ...
    #print(y[:,1])
    # a trial to correct valid loss (failure , still inf) : 
    #y[:,1] = np.divide(y[:,1],100)
    print(y.shape)
    #print(y[:,1])
...
def train_model(model, args, X_train, X_valid,y_train,y_valid):
    ...
    #print(len(X_train))
    #print(len(y_train))
    data_train_batched = batch_generator(args.data_dir, X_train, y_train, args.batch_size, True)
    data_valid_batched = batch_generator(args.data_dir, X_valid, y_valid, args.batch_size, False)
...
def main():
    ...
    parser.add_argument('-d', help='data directory',        dest='data_dir',          type=str,   default='TrainingV3')
